        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plane_Airline_AirlinesAirlineId",
                        column: x => x.AirlinesAirlineId,
                        principalTable: "Airline",
                        principalColumn: "AirlineId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Plane_Airport_AirportId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaneId = table.Column<int>(type: "int", nullable: false),
                    AirportFromAirportId = table.Column<int>(type: "int", nullable: false),
                    AirportToAirportId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Flight", x => x.FlightId);
                    table.ForeignKey(
                        name: "FK_Flight_Airport_AirportFromAirportId",
                        column: x => x.AirportFromAirportId,
                        principalTable: "Airport",
                        principalColumn: "AirportId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flight_Airport_AirportToAirportId",
                        column: x => x.AirportToAirportId,
                        principalTable: "Airport",
                        principalColumn: "AirportId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ticket_Airline_AirlinesAirlineId",
                        column: x => x.AirlinesAirlineId,
                        principalTable: "Airline",
                        principalColumn: "AirlineId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flight_AirportFromAirportId",
                table: "Flight",
                column: "AirportFromAirportId");

            migrationBuilder.CreateIndex(
                name: "IX_Flight_AirportToAirportId",
                table: "Flight",
                column: "AirportToAirportId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Plane_AirlinesAirlineId",
                table: "Plane",
                column: "AirlinesAirlineId");

            migrationBuilder.CreateIndex(
                name: "IX_Plane_AirportId",
                table: "Plane",
                column: "AirportId");

            migrationBuilder.CreateIndex(
                name: "IX_Ticket_AirlinesAirlineId",
                table: "Ticket",
                column: "AirlinesAirlineId");
